config = dict(
    ...
    inference=dict(
        ...
        params=dict(
            save_path='./test',
            checkpoint_path='/home/zhw2021/code/HOneCls/log/HongHuDataset/SelfCalibrationTrainer/TaylorVarPULossPf/SimpleFreeOCNet/4/2022-08-20 18-20-30/model_t/checkpoint_t.pth',
        )
    ),
    meta=dict(
        image_size=(678, 465),
