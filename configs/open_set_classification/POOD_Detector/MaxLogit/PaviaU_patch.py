config = dict(
    ...
    trainer=dict(
        ...
        params=dict(
            detector_name='MaxLogit',
            # MCD, MaxSoftmax, Mahalanobis, EnergyBased, Entropy, MaxLogit, ODIN, KLMatching
            checkpoint_path="/home/zhw2021/code/HOneCls/tools/Log/OpenSet/OsMccPaviaUDataset/OsDS3LTrainer_PB/DS3L_MSE_Loss/MetaFreeNetEncoder/2023-06-28 22-21-36/checkpoint.pth",
            patch_size=9,
            batch_size_pb=256,
        ),
    ),
