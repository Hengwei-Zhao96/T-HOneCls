config = dict(
    ...
    trainer=dict(
        ...
        params=dict(
            ...
            checkpoint_path="/home/zhw2021/code/HOneCls/tools/Log/OpenSet/OsMccIndianPinesDataset/OsDS3LTrainer_PB/DS3L_MSE_Loss/MetaFreeNetEncoder/2023-06-29 08-54-43/checkpoint.pth",
            patch_size=9,
            batch_size_pb=256,
        ),
    ),
