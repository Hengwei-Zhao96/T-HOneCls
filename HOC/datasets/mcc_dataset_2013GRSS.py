...
class Mcc2013GRSSDataset(MccFullImageDataset):
    def __init__(self, image_path, gt_path, train_flage, num_classes, num_train_samples_per_class=200,
        ...
        super(Mcc2013GRSSDataset, self).__init__(image=image, mask=mask, train_label=train_label,
        ...
        # super(Mcc2013GRSSDataset, self).__init__(image=image, mask=mask,
        #                                          np_seed=SEED, num_classes=self.num_classes,
        #                                          train_flage=self.train_flag,
        #                                          num_train_samples_per_class=self.num_train_samples_per_class,
        #                                          sub_minibatch=self.sub_minibatch)
